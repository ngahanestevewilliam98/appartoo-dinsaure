...
module.exports = class database{
    ...
    static async connection(dbAccess = undefined){
        ...
        this._db = new Database(`http://${this._database['database']['host']}:${this._database['database']['port']}/`);
        this._db.useBasicAuth(this._database['database']['user'], this._database['database']['password']);
        this._db.createDatabase(this._database['database']['db']).then(
            () => {
